...
function Features() {
    ...
    return (<section className="features-section">
            ...
            <div className="features-section-info">
                ...
                <p>Identify the longest-working colleagues and list all their shared projects along with the respective
                    periods they worked on these projects. Explore all projects from your file data and the employees
                    who have contributed to them.</p>
            </div>
            }
            <ul className="features-list">
                ...
                <NavLink to="/partners"
                         className={({isActive}) => (isActive ? "feature-link active" : "feature-link")}>
                    <Feature title={"All Partners"} image={partners}/>
                </NavLink>
